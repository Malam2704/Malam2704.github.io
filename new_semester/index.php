...
<html lang="en">
    <head>
        ...
        <link href="assets/css/home_page.css" rel="stylesheet" type="text/CSS">
    ...
    <body>
        ...
        <div id="exercises">
            ...
            <ol>
                ...
                <li ><a href="modularSiteStart/index.php">PHP Demo</a></li>
                <li ><a href="exercise_six.html">Exercise 6</a></li>
        ...
        <div id="individual">
            ...
            <ol>
                <li ><a href="project1/index.html">Project 1</a> - First edition of my education website about my home, New York City, The Mobile Version is in Progress</li>
